...
namespace Netifi.Quickstart
{
    public class Server
    {
        static async Task Main(string[] args)
        {
			...
			var client = new Netifi.Broker.Client.BrokerClient(accessKey, accessToken, null, null, "quickstart.services.helloservices", "serviceName", 0, new SortedDictionary<string, string>(), transport, RSocketOptions.Default);
